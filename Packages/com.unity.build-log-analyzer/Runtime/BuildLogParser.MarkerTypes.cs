...
namespace Unity.Profiling.BuildLogAnalyzer
{
    public partial class BuildLogParser
    {
        ...
        public static readonly List<MarkerType> MarkerTypes = new()
        {
            ...
            {
                name = "Unity Process",
                openText = "[UnityConnectServicesConfig]",
                closeStartingTexts = new[] { "Input System module state changed to: Shutdown" }
            },
            
            new()
            {
                name = "Cache Server Retrieval",
                openText = "Querying for cacheable assets in Cache Server",
                closeStartingTexts = new[] { "Start importing" }
            },
            ...
            new SingleMessageMarker
            {
                ...
                openText = "[Package Manager] Done resolving packages in",
                preDurationText = "packages in ",
